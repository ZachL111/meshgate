"""Regression checks for the meshgate casebook."""
...
from casebook.harness import assert_expected, meshgate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meshgate_summary(), assert_expected())
