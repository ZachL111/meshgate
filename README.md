...
meshgate is a Go project for platform engineering. It focuses on this technical goal: Model service-mesh routes, retries, traffic splits, and budgets.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 154, risk penalty 4, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
